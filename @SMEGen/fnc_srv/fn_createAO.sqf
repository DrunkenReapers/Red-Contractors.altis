...
private [	"_type", "_configArrayGroups", "_arrayGroups", "_inf", "_siteMkr","_typeMkr","_sitePos", "_taskPos", "_siteName", "_siteSize", "_siteAngle", "_typeDesc",
...
_typeMkr			= getText ( missionConfigFile >> "cfgRandomMissions" >> "missionSites" >> worldName >> _site >> "markerType" );
...
T8SME_server_var_arrayCurrentTasks pushBack [ _siteMkr, _setTaskDesc, _setTaskName, _taskPos, _typeMkr ];
