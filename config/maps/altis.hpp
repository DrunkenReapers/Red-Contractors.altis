...
//---------------------------------------------------------------
// missionSites - HUMANITARIAN . ho creato la classe humanitarian per le sidemission di aiuto popolazione 
	class town_Panochori : base_help
	{
		scope		= 1;
		name		= "Panochori";
		marker		= "site_town_panochori";
		position[]	= { 5025.18,11235.9,0 };
	};

	class town_Neri : base_help
	{
		scope		= 1;
		name		= "Neri";
		marker		= "site_town_neri";
		position[]	= { 4145.34,11824.7,0 };
	};
